        ...
        <main class="bg-black">
            ...
            <div class="container">                
                <form method="GET" class="mb-4">
                    <div class="input-group">
                        <input type="text" name="search" class="form-control bg-dark text-light" placeholder="Search by Employee Name, Leave ID, etc." value="<?php echo htmlspecialchars($searchTerm); ?>">
                        <div class="input-group-append">
                            <button class="btn btn-outline-secondary bg-warning" type="submit">Search</button>
                        </div>
                    </div>
                </form>
                            ...
                            <?php if ($result->num_rows > 0): ?>
                                ...
                                <tr>
                                    ...
                                    <td class="bold-status <?php 
                                        ...
                                        } elseif (htmlspecialchars($row['status']) === 'Supervisor Approved') { echo 'text-warning'; }
